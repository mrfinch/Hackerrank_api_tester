...
function makeApiReq(test_id,cid,data,callhelper,host){
	console.log('************************************************');
	console.log("New Request");
	console.log(data);
	console.log('Test id:'+test_id);
	console.log('Candidate id:'+test_id);
	var endpoint = "/x/api/v2/tests/" + test_id + "/candidates/" + cid + "?" + querystring.stringify(data);
...
function startTesting(){
	makeApiReq(test_id,cid,query,0,host);
}
...
{
	console.log('Candidate id requried');
	process.exit(1);	
}
